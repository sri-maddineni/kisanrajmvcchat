            ...
            <div className="container" style={{ display: "flex", flexDirection: "row", justifyContent: "flex-start" }}>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" onClick={() => { setCategory("all") }} href="#">All</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("food-grains-cereals") }} href="#">FOOD GRAINS/CEREALS</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("oilseeds") }} href="#">OILSEEDS</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("fruits") }} href="#">FRUITS</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("vegetables") }} href="#">VEGETABLES</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("spices") }} href="#">SPICES</a></li>
                        <li><a class="dropdown-item" onClick={() => { setCategory("misc") }} href="#">MISC</a></li>
