    ...
    <>
      ...
      <div className="container" style={{ display: "flex", flexDirection: "row", justifyContent: "flex-start" }}>
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu">
            <li><a className="dropdown-item" onClick={() => { setCategory("all"); setFilterstate(false) }} href="#">All</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("food-grains-cereals"); setFilterstate(true) }} href="#">FOOD GRAINS/CEREALS</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("oilseeds"); setFilterstate(true) }} href="#">OILSEEDS</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("fruits"); setFilterstate(true) }} href="#">FRUITS</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("vegetables"); setFilterstate(true) }} href="#">VEGETABLES</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("spices"); setFilterstate(true) }} href="#">SPICES</a></li>
            <li><a className="dropdown-item" onClick={() => { setCategory("misc"); setFilterstate(true) }} href="#">MISC</a></li>
      ...
      <div className="container" style={{ minHeight: "50vh" }}>
        <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", }}>
          {wishlist.map((item) => (
            <div className="card" style={{ display: 'flex', flexDirection: "column", width: "30rem" }} key={item._id} ><span
              ...
              <div style={{ display: "flex", flexDirection: "row", }}>
                <button style={{ width: "100px", height: "30px" }} className='btn btn-sm btn-outline-info m-1' onClick={() => { navigate(`/dashboard/user/buy-commodity/${item.commodityId.category}`) }}>view details</button>
